                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($all_stocks as $stock): ?>
                            <?php if ($stock['is_deleted'] == 1 || $stock['status'] == 0) continue; ?>
                            <tr>
                                <td><?= $no++ ?></td>
                                ...
                                <td>
                                    <div class="actions">
                                        <button class="btn btn-in open-stock-in"
                                            data-id="<?= $stock['product_id_fk'] ?>"
                                            data-name="<?= htmlspecialchars($stock['product_name'], ENT_QUOTES) ?>">
                                            <i class="fa-solid fa-circle-plus"></i>
                                            <span>Stock IN</span>
                                        </button>
                                        <button class="btn btn-out open-stock-out"
                                            data-id="<?= $stock['product_id_fk'] ?>"
                                            data-name="<?= htmlspecialchars($stock['product_name'], ENT_QUOTES) ?>">
            ...
            <div class="add-modal <?= $open_modal_stockout ? 'active' : '' ?>" id="stock-out-modal">
                <form action="../validation/stock/stock_out_process.php" method="POST">
                    ...
                    <div class="body">
                        ...
                        <button type="submit" name="stock_out_btn" style="background:#c82828;">Confirm Stock OUT</button>
                    </div>
                </form>
            </div>
