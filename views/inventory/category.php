                    ...
                    <div class="body">
                        <div class="input">
                            ...
                            <input type="text" name="category_name" placeholder="Category Name"
                                value="<?= htmlspecialchars($old_inputs['category_name'] ?? '') ?>">
                        </div>

                        <div class="input">
                            <label for="">Description (OPTIONAL) </label>
                            <i class="fas fa-align-left"></i>
                            <textarea name="category_description" placeholder="Category Description"><?= htmlspecialchars($old_inputs['category_description'] ?? '') ?></textarea>
                        </div>
